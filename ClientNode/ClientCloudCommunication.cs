...
{
    public class ClientCloudCommunication
    {
        ...
        public readonly string CLIENT_EMULATION_NAME;
        public readonly string CLIENT_EMULATION_ADDRESS;
        public readonly int CLIENT_EMULATION_PORT;       

        public ClientCloudCommunication(string instancePort, string nodeId, string nodeEmulationAddress, string nodeEmulationPort)
        { 
            this.instanceAddress = IPAddress.Parse("127.0.0.1");
            this.cloudPort = 62572;
            this.instancePort = Int32.Parse(instancePort);
            this.CLIENT_EMULATION_NAME = nodeId;
            this.CLIENT_EMULATION_ADDRESS = nodeEmulationAddress;
            this.CLIENT_EMULATION_PORT = Int32.Parse(nodeEmulationPort);
